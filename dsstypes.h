...
int pr_cust PROTO((customer_t * c, int mode, int reset));
...
int pr_order PROTO((order_t * o, int mode, int reset));
...
int pr_part PROTO((part_t * part, int mode, int reset));
...
int pr_supp PROTO((supplier_t * supp, int mode, int reset));
...
int pr_nation PROTO((code_t * c, int mode, int reset));
int ld_nation PROTO((code_t * c, int mode));
int mk_region PROTO((DSS_HUGE i, code_t *c));
int pr_region PROTO((code_t * c, int mode, int reset));
